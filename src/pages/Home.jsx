...
export const Home = () => {
	const [typingText] = useTypewriter({
		words: ["Mobile Developer", "Web Developer", "Musician", "Designer"],
		typeSpeed: 100,
		deleteSpeed: 100,
		delaySpeed: 1000,
		loop: {},
	...
	return (
		...
		>
			<div className="home-content">
				...
				<p>
					This is my official portfolio website to show all my projects and
					experiences in Mobile and Web development.
				</p>
